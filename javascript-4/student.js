...
// CODE HERE
var faveColors = ['green', '#orange', 'red'];
...
var me = {
    firstName: 'Doug', 
    superHeroName: 'Quailman', 
    homeTown: 'Bluffington', 
    superPowers: ['flying', 'crime fighting', 'saving Patty Mayonnaise'],
...
// CODE HERE
function setPowers(arr createLi() {
