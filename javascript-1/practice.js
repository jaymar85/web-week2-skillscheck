...
// Code Here
var myNumbersIndex = [];
myNumbers.forEach(function (item, array) {
	myNumbersIndex.push(array[i]);
});
...
forTheLoveOfGeorge = notGeorge.map(function (index, array) {
	return array.length = "George";
})
...
enemies = people.filter(function (element) {
	if(element === false) {
